...
from .mha import MultiHeadAttention,RelPositionMultiHeadAttention
...
class ConformerConvolution(nn.Module):
    ...
    def __init__(self, d_model, kernel_size, norm_type='batch_norm', pointwise_activation='glu_'):
        ...
        self.activation = activation_registry["swish"]()
...
class ConformerFeedForward(nn.Module):
    ...
    def __init__(self, d_model, d_ff, dropout, activation=activation_registry["swish"]()):
